...
public class FWCVideoHeaderRequestThread extends Thread{
	private static final String TAG = FWCVideoHeaderRequestThread.class.getSimpleName();
	...
	public FWCVideoHeaderRequestThread(String title, Handler handler) {
		this.mHandler = handler;
		this.mTitle = title;
	}

	public FWCVideoHeaderRequestThread(String title, Handler handler, int requestNum) {
		this.mHandler = handler;
		this.mTitle = title;
		this.mRequestNum = requestNum;
	}

	public FWCVideoHeaderRequestThread(String title, Handler handler, int requestNum, String timeStamp) {
		this.mHandler = handler;
		this.mTitle = title;
		this.mRequestNum = requestNum;
