...
//    public static final String SM_BASIC_URL = "https://contentapi.celltick.com/mediaApi/v1.0/personal/content?publisherId=VIVO-Web&key=WW5CCec3QsLyx2tGjEPHT0ptUKbqbif7";
    ...
    public static String REQUEST_BODY_JSON = "{\n" +
            "  \"placements\": [\n" +
            "      {\n" +
            "          \"name\": \"Placement-Name\",\n" +
            "          \"recCount\": recCount-number,\n" +
            "          \"organicType\": \"mix\"\n" +
            "      }\n" +
            "  ],\n" +
            "  \"app\": {\n" +
            ...
            "      \"session\": \"session-id\",\n" +
            "      \"realip\": \"real-ip\",\n" +
            "      \"agent\": \"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36\",\n" +
            "      \"device\": \"gaid\"\n" +
            "  }\n" +
            "}";
