...
public class CricketVideoRequestThread extends Thread{
	private static final String TAG = CricketVideoRequestThread.class.getSimpleName();
	...
	public CricketVideoRequestThread(Handler handler, int offset) {
	...
	public void run() {
		...
		URL = getVideoRequestBaseURL() +"&limit="+Constant.NUM_SM_NORMAL_REQUEST+"&offset="+offset+"&tag=cricket";
	...
	private String getVideoRequestBaseURL(){
		return ApiUrl.getVideoBaseURL()
