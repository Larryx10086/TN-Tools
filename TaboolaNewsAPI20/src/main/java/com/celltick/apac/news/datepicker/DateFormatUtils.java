...
public class DateFormatUtils {
    ...
    //yyyy-MM-dd转MM/dd/yyyy
    public static String y_M_d2M_d_y(String y_M_d){
        String str2 = "06/01/2019";
        try{
            SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
            Date date= sdf.parse(y_M_d);//字符串转成date对象类型
            DateFormat sdf2=new SimpleDateFormat("MM/dd/yyyy");
            str2= sdf2.format(date);//date类型转换成字符串
