...
public class CricketWidgetScheduleListAdapter extends RecyclerView.Adapter<CricketWidgetScheduleListAdapter.ViewHolder>{
    private static final String TAG = CricketWidgetScheduleListAdapter.class.getSimpleName();
    ...
    public CricketWidgetScheduleListAdapter(List<CricketInfo> mCricketGameList){
        this.mCricketGameList = mCricketGameList;
    }

    @Override
    public CricketWidgetScheduleListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cricket_widget_item,parent,false);
        RecyclerView.ViewHolder holder = new ViewHolder(view);
        return (ViewHolder) holder;
    }
    @Override
    public void onBindViewHolder(final CricketWidgetScheduleListAdapter.ViewHolder holder, int position) {
        ...
        //将Jun 3, 2019 9:30:00 AM 转化成24小时制 06/03/2019 09:30:00
