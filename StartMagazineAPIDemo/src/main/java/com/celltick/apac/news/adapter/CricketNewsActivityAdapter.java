 ...
 *
 */
public class CricketNewsActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = CricketNewsActivityAdapter.class.getSimpleName();
    ...
    public CricketNewsActivityAdapter(Context context, List<ArticleBean> mArticleList) {
