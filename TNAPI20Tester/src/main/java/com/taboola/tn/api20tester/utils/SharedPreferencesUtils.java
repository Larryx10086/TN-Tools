...
/**
 * Created by Larryx on 8/15/2018.
 */
...
public class SharedPreferencesUtils {
    ...
    private String SHARED_NAME = "StartNews";//sp的文件名 自定义


//    MyAPP.getContext() 是你的Application里面的一个Context
    private SharedPreferencesUtils() {
        share = TNAPI20Tester.getContext().getSharedPreferences(SHARED_NAME, Context.MODE_PRIVATE);
        editor = share.edit();
    }
