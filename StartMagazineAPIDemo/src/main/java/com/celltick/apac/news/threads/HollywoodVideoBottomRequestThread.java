...
public class HollywoodVideoBottomRequestThread extends Thread{
	private static final String TAG = HollywoodVideoBottomRequestThread.class.getSimpleName();
	...
	public HollywoodVideoBottomRequestThread(Handler handler, int offset) {
		this.mHandler = handler;
		this.offset = offset;
	}

	public HollywoodVideoBottomRequestThread(String title, Handler handler, int offset) {
		this.mHandler = handler;
		this.mTitle = title;
		this.offset = offset;
	}
