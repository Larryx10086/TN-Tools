...
public class FWCVideoBottomRequestThread extends Thread{
	private static final String TAG = FWCVideoBottomRequestThread.class.getSimpleName();
	...
	public FWCVideoBottomRequestThread(Handler handler, int offset) {
		this.mHandler = handler;
		this.offset = offset;
	}

	public FWCVideoBottomRequestThread(String title, Handler handler, int offset) {
		this.mHandler = handler;
		this.mTitle = title;
		this.offset = offset;
	}
