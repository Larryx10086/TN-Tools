...
public class HollywoodVideoHeaderRequestThread extends Thread{
	private static final String TAG = HollywoodVideoHeaderRequestThread.class.getSimpleName();
	...
	public HollywoodVideoHeaderRequestThread(String title, Handler handler) {
		this.mHandler = handler;
		this.mTitle = title;
	}

	public HollywoodVideoHeaderRequestThread(String title, Handler handler, int requestNum) {
		this.mHandler = handler;
		this.mTitle = title;
		this.mRequestNum = requestNum;
	}

	public HollywoodVideoHeaderRequestThread(String title, Handler handler, int requestNum, String timeStamp) {
		this.mHandler = handler;
		this.mTitle = title;
		this.mRequestNum = requestNum;
